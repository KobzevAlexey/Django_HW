...
def index(request):
    ...
    return render(request, 'seminar3app/index.html', context)
...
def fake_clients(request, count):
    ...
    return render(request, 'seminar3app/fake.html', context)
...
def show_client_orders(request, pk):
    ...
    return render(request, 'seminar3app/show_client_orders.html', context)
...
def list_goods_period_of_time(request, days, pk):
    ...
    return render(request, 'seminar3app/list_goods_period_of_time.html', context)
