...
def index(request):
    return render(request, 'seminar5app/index.html')
...
def add_product(request):
    ...
    return render(request, 'seminar5app/product_add.html', {'form': form, 'message': message, 'title': 'Добавить продукт'})
...
def update_product(request):
    ...
    return render(request, 'seminar5app/product_add.html', {'form': form, 'message': message, 'title': 'Обновить продукт'})


def show_products(request):
    products = Product.objects.all()
    return render(request, 'seminar5app/index.html', {'products': products})


def show_clients(request):
    clients = Client.objects.all()
    return render(request, 'seminar5app/index.html', {'clients': clients})
